       ...
       const grid = document.getElementById('puzzle-grid');
        ...
        window.onload = () => {
            ...
            if (score >= 500) {
                ...
                feedback.innerText = "Ты настоящий знаток! Твои знания достойны высшей похвалы.";
            } else if (score >= 300) {
                rankText.innerText = "Активист";
                feedback.innerText = "Хороший результат! Ты уверенно ориентируешься в теме.";
            } else {
                rankText.innerText = "Новичок";
                feedback.innerText = "Неплохо для начала! Попробуй пройти станции еще раз, чтобы закрепить знания.";
            }
        };
